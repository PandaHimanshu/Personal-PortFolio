...
function Contact() {
  return (
    ...
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://github.com/PandaHimanshu" class="hover:underline">Himanshu™</a>. All Rights Reserved.</span>
    </div>
</footer>
